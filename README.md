...
See `AI_STUDIO_IMPORT.md`. This v14 package keeps the Play Console applicationId unchanged and removes optional build/test plugins that are not needed for app runtime.
